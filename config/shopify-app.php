...
return [
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', '8e7afe97b87a8512386092c4406b52be'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', '7bf19f7d5e5b2e32ab3f5a06f5ff7e2e'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,read_customers,write_customers,read_orders,read_discounts,write_discounts,read_price_rules,write_price_rules,write_content,read_content'),
